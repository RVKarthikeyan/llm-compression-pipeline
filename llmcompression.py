...
print("   - google/gemma-3-12b-it (Teacher model)")
print("   - google/gemma-3-1b-it (Student model)")
...
# Load Teacher Model: Google Gemma 3 12B
import torch
...
print("="*70)
print("Loading Teacher Model: Google Gemma 3 12B")
print("="*70)
...
# Load Gemma 3 12B Instruction-tuned model
